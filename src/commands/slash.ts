...
import {
  ...
  renderHud, timerLive, createTimer,
  type HudElementId, type HudRenderState,
} from "../core/hud.js";
...
async function addSlash(ctx: AppContext, out: Writable, arg: string): Promise<void> {
...
async function hudSlash(ctx: AppContext, out: Writable, arg: string): Promise<void> {
  const parts = arg.trim().split(/\s+/);
...
function buildHudState(reg: import("../core/context_registry.js").ContextRegistry): HudRenderState {
