...
- [2026-08-22](2026-08-22.md) — **v0.3.0**: `aether skills`, `aether capabilities`, `aether support-bundle`, plus the unpublished 0.2.0 work and nine fixes. Packet: [OPERATOR-PACKET-v0.3.0.md](OPERATOR-PACKET-v0.3.0.md).
