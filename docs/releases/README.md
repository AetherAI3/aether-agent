...
- [2026-08-22](2026-08-22.md) — **v0.3.0**: the `aether review` → `aether ship` rail, `aether sessions`, skills enforced inside real runs, `aether skills`, `aether capabilities`, `aether support-bundle`, plus the unpublished 0.2.0 work and eleven fixes. Packet: [OPERATOR-PACKET-v0.3.0.md](OPERATOR-PACKET-v0.3.0.md).
