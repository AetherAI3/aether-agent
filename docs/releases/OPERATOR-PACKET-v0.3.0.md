...
| Current exact-head dry run | 612 entries / 3,283,857 unpacked bytes / 4 workflows |
| Current dry-run predicted packed size | 795,710 bytes (inventory estimate; no archive was created) |
...
3,283,857 unpacked bytes, and 4 workflows; the matching dry-run JSON predicted
795,710 packed bytes. This was an
...
The exact-head dry run reported 612 entries and 3,283,857 bytes unpacked. Five
