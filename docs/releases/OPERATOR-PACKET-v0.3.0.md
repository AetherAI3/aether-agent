...
| Current exact-head dry run | 612 entries / 3,285,365 unpacked bytes / 4 workflows |
| Current dry-run predicted packed size | 796,259 bytes (inventory estimate; no archive was created) |
...
3,285,365 unpacked bytes, and 4 workflows; the matching dry-run JSON predicted
796,259 packed bytes. This was an
...
The exact-head dry run reported 612 entries and 3,285,365 bytes unpacked. Five
