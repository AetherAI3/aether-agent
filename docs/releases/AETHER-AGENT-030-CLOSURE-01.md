...
| C3 | [Cloud PR #1329](https://github.com/AetherAI3/AETHER-CLOUD/pull/1329) merged as `63586bce737a80f3ca81e6f2b7a7b9054a107452` | Historical integration record: durable owner-bound redemption landed. This row is not a substitute for the separate production evidence required by the release gate. |
...
| C5 | Agent manifest/catalogue integration plus [Cloud PR #1327](https://github.com/AetherAI3/AETHER-CLOUD/pull/1327), merged from head `70e0645c96b16dedfefb90dd403daecb3c3d3b25` as squash `fbb7b98a96682820b85a4bface002dcbf5bf9c37` | Product-policy approval and ordinary CI are recorded. Qualified production proof at `https://api.aethersystems.net/cloud/public/model-catalogue` returned the 51-row safe projection; `/cloud/healthz` reported deployed Cloud `b95c2aac0a96`. |
...
| C7 | [Agent PR #107](https://github.com/AetherAI3/aether-agent/pull/107) is the controlled candidate and remains draft | The final immutable head requires fresh CI/CodeQL, independent review, real backend deployment/response proof for the landed catalogue, and a genuine Agent-bound Predator result before any merge or publication. |
